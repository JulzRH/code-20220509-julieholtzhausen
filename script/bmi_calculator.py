...
def run():
    ...
    print('Please select json file containing data')
    root = tk.Tk()
    root.withdraw()
    ...
    print('For data with added columns, see generated file "bmi_data_output" which has been created in same directory')
